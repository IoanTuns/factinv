...
import decimal
from invoice.managers import get_accounting_software_manager
from invoice.models.models import Invoice, Item, VatValue
from invoice.models.doc_series import DocumentSeries

admin.site.register(VatValue)
...
class InvoiceAdmin(admin.ModelAdmin):
    ...
    #         'fields': (
    #             'type', 'status', 'language', ('sequence', 'number'), 'subtitle', 'related_document', 
    ...
    #         'fields': (
    #             'supplier.company.denumire', 'supplier_street', 'supplier_zip', 'supplier_city', 'supplier_country',
    ...
    def get_queryset(self, request):
        return self.model.objects.annotate(annotated_subtotal=F('total')-Coalesce(F('vat'), decimal.Decimal(0.0)))
